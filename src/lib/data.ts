...
export const calendarEvents = [
  {
    ...
    end: new Date(2024, 7, 8, 8, 45),
  },
  {
    title: "English",
    allDay: false,
    start: new Date(2024, 7, 8, 9, 0),
    end: new Date(2024, 7, 8, 9, 45),
  },
  {
    title: "Biology",
    allDay: false,
    start: new Date(2024, 7, 8, 10, 0),
    end: new Date(2024, 7, 8, 10, 45),
  },
  {
    title: "Physics",
    allDay: false,
    start: new Date(2024, 7, 8, 11, 0),
    end: new Date(2024, 7, 8, 11, 45),
  },
  {
    title: "Chemistry",
    allDay: false,
    start: new Date(2024, 7, 8, 13, 0),
    end: new Date(2024, 7, 8, 13, 45),
  },
  {
    title: "History",
    allDay: false,
    start: new Date(2024, 7, 8, 14, 0),
    end: new Date(2024, 7, 8, 14, 45),
  },
  {
    title: "English",
    allDay: false,
    start: new Date(2024, 7, 9, 9, 0),
    end: new Date(2024, 7, 9, 9, 45),
  },
  {
    title: "Biology",
    allDay: false,
    start: new Date(2024, 7, 9, 10, 0),
    end: new Date(2024, 7, 9, 10, 45),
  },
  {
    title: "Physics",
    allDay: false,
    start: new Date(2024, 7, 9, 11, 0),
    end: new Date(2024, 7, 9, 11, 45),
  },

  {
    ...
    end: new Date(2024, 7, 9, 14, 45),
  },
  {
    title: "Math",
    allDay: false,
    start: new Date(2024, 7, 10, 8, 0),
    end: new Date(2024, 7, 10, 8, 45),
  },
  {
    title: "Biology",
    allDay: false,
    start: new Date(2024, 7, 10, 10, 0),
    end: new Date(2024, 7, 10, 10, 45),
  },
